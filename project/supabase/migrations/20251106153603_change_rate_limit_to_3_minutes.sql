/*
  # Change Rate Limit to 3 Minutes
  
  1. Changes
    - Increase cooldown from 5 seconds to 3 minutes (180 seconds)
    - Update validation trigger to enforce 3-minute delay
...
-- Update validation function with 3-minute cooldown
...
BEGIN
  ...
  IF last_message_time IS NOT NULL THEN
    ...
    -- Changed from 5 seconds to 3 minutes (180 seconds)
...
-- Update restrictive policy to match 3-minute cooldown
