    ...
    const checkAuth = async () => {
      if (AuthService.isAuthenticated()) {
        ...
        if (currentUser?.success && currentUser.username) {
          navigate('/dapp/chat', { replace: true });
          return;
        }
      }
      setIsChecking(false);
  ...
  if (isChecking) {
    return (
      <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
        <div className="w-8 h-8 border-4 border-[#17ff9a] border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }
              ...
              <div className="text-center space-y-8">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-4 sm:pt-6">
                  <button
                    ...
                    className="group relative w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 bg-gradient-to-r from-[#17ff9a] to-[#17ff9a] text-black font-semibold rounded-full hover:shadow-[0_0_40px_rgba(23,255,154,0.5)] transition-all duration-300 hover:scale-105"
                  >
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 bg-transparent border-2 border-gray-700 text-white font-semibold rounded-full hover:border-gray-500 hover:bg-[#1a1a1a] transition-all duration-300"
                  >
                    Documentation
                  </button>
                </div>

                <div className="pt-6 sm:pt-8 flex items-center justify-center gap-4">
                  <a
                    href="https://x.com/ZKForge_io"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-[#1a1a1a] border border-[#2a2a2a] hover:border-[#17ff9a] hover:bg-[#0d3d2a] transition-all duration-300 group"
                    aria-label="Follow us on X"
                  >
                    <svg className="w-5 h-5 text-gray-400 group-hover:text-[#17ff9a] transition-colors" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                    </svg>
                  </a>

                  <a
                    href="https://github.com/ZKForgeIO/ZKForge-Repo"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center w-12 h-12 rounded-full bg-[#1a1a1a] border border-[#2a2a2a] hover:border-[#17ff9a] hover:bg-[#0d3d2a] transition-all duration-300 group"
                    aria-label="View on GitHub"
                  >
                    <svg className="w-6 h-6 text-gray-400 group-hover:text-[#17ff9a] transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative grid lg:grid-cols-2 gap-8 lg:gap-12 px-6 py-10 sm:px-10 sm:py-14 lg:px-16 lg:py-20">
              <div className="flex flex-col justify-center space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2">
                  ...
                  <button
                    onClick={() => navigate('/dapp/auth')}
                    className="px-6 py-3 bg-gradient-to-r from-[#17ff9a] to-[#17ff9a] text-black font-semibold rounded-full hover:shadow-[0_0_30px_rgba(23,255,154,0.4)] transition-all duration-300"
                  >
                    Try the Ecosystem
                  </button>
                </div>
